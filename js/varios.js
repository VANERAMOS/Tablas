			...
			for (i=1; i<=10; i++){
				...
				if (isNaN(sValorCapturado))
					...
					if (nCapturado == (nTabla*i)){
						nCalif++;
						oCeldaCal=document.getElementById("Ok"+i)
						oCeldaCal.innerHTML=" ok ";
							sValorCapturado = document.getElementById("txtResultado"+i).style="text-aling:center; border: 4px solid #4bf510; background-color: #4bf510";
					}
					else{
						oCeldaCal=document.getElementById("Ok"+i)
						oCeldaCal.innerHTML=" not ok ";
							sValorCapturado = document.getElementById("txtResultado"+i).style="text-aling:center; border: 4px solid #ae2012; background-color: #ae2012";
					}
				}
			}
